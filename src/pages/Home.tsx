    ...
    <div className="flex flex-col">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white w-full">
          <div className="max-w-3xl">
            ...
            <motion.p 
              ...
              className="text-sm sm:text-lg md:text-xl text-gray-300 mb-8 sm:mb-12 max-w-lg leading-relaxed font-medium"
            >
      ...
      <section className="py-16 sm:py-24 bg-[#c6dcff] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div 
            className="relative h-[480px] sm:h-[500px] md:h-[450px]"
            ...
            <h2 className="text-xl sm:text-3xl md:text-5xl font-black tracking-tight text-gray-900 mb-4 sm:mb-6 uppercase leading-tight">Why Choose DNA Cult Fitness?</h2>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8 sm:mb-10">
                {[
                  ...
                  <li key={i} className="flex items-center text-gray-700 text-sm sm:text-base font-medium">
